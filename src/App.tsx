                  ...
                  return (
                    <div className="flex-1 flex flex-col gap-5 animate-fade-in text-left">
                      ...
                      <div className="flex justify-between items-center bg-transparent">
                        ...
                        <button
                          type="button"
                          className="p-2.5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-slate-300 dark:hover:border-slate-700 shadow-3xs hover:scale-105 active:scale-95 transition-all"
                          title="Notifications"
                        >
